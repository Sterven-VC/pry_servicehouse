    ...
    <footer>
      <div className="footer-main">
        ...
        <div className="footer-links">
          <div><a href={section('servicios')}>Servicios</a><a href="/servicio-tecnico-lavadoras-lima/">Servicio técnico de lavadoras</a><a href={section('zonas')}>Zonas de atención</a><a href={section('preguntas')}>Preguntas frecuentes</a></div>
