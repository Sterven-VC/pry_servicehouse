...
const documents = {
  ...
  privacy: {
    ...
    content: <>
      ...
      <Section id="publicidad" title="6. Analítica y publicidad"><p>Podemos recibir visitas desde campañas de Google Ads. Con tu consentimiento, usamos Google Analytics 4 para obtener estadísticas agregadas sobre visitas, navegación y clics en los enlaces de contacto. Un clic no confirma que se haya enviado un mensaje o atendido una llamada. No enviamos a Analytics el contenido de mensajes, teléfonos, direcciones ni fotografías. No instalamos etiquetas de remarketing ni Meta Pixel. Puedes rechazar o retirar el consentimiento desde “Configurar cookies” al pie del sitio.</p></Section>
